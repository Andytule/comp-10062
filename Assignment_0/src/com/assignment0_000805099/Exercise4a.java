...
/**
 * Solution to Week 2 Exercise 4a. Includes solution to 3a as a subset.
 *
 * @author Sam Scott
 */
public class Exercise4a extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        int choice;
        do {
            System.out.println("What kind of shape? 1=square, 2=circle, 3=arc, 4=quit and show");
            choice = sc.nextInt();
            if (choice != 4) {
